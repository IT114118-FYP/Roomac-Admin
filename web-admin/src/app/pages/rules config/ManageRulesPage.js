...
function ManageRulesPage(props) {
	...
	const fetchData = () => {
		setLoading(true);
		axiosInstance.get("api/branches/ST/settings").then(({ data }) => {
		...
		<NavDrawer>
			<div>
				...
				<Typography variant="body1" color="textSecondary" gutterBottom>
					View and manage rules configurations with customisations
				</Typography>
			</div>
			<Divider className={classes.divider} />
			<Typography variant="h6" gutterBottom>
				View rules configurations
			</Typography>
